...
let
  ...
  bucket = "ncps";
  region = "us-west-1";
  accessKey = builtins.toFile "minio-access-key" "easy-key"; # ''strongkey"with$pecial'aracter)'';
  secretKey = builtins.toFile "minio-secret-key" "easy-secret"; # ''strongsecret"with$pecial'aracter)'';

  # pg creds
  postgresPassword = "easypwd"; # ''strongpwd"with$pecial'aracter)'';

  # redis creds
  redisPassword = "easypwd"; # ''strongpwd"with$pecial'aracter)'';
